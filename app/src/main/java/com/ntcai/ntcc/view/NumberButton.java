...
public class NumberButton extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.button_sub) {
            if (count > 1) {
                ...
                if (mOnAddSubListener != null) mOnAddSubListener.onChangeListener((count - 1));
    ...
    public void setOnAddSubListener(OnAddSubListener mOnAddSubListener) {
        this.mOnAddSubListener = mOnAddSubListener;
    }
    ...
    public interface OnAddSubListener {
        void onChangeListener(int count);
