...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<RightGoodVo> mDatas;
    ...
    public ItemHeaderDecoration(Context context, List<RightGoodVo> datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration setData(List<RightGoodVo> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
